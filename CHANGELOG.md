...
- Populate `instance.extra_fields["resubmission_stage_id"]` before `before_resubmission()` runs so custom handlers can validate and route resubmissions using the original instance.
